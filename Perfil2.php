...
<body>
  ...
  <div class="contenedor">
    <h1>Perfil de usuario de <?php echo $row['nom_usu']?> </h1>
    <form action="php/editar_usuario.php" method="POST"  id="formulario">
      ...
      <ul>
        ...
        <!-- tel -->
        <li class="fila">
          <input type="tel" id="celular" name="celular" maxlength="9" size="11" value="<?php echo $row['celu_usu']?>" pattern="[0-9]{9}" />
          <label for="direction" class="propiedad">Celular</label>
        
        <li class="fila">
          <input type="dir" id="Direccion" name="Direccion"  size="30" value="<?php echo $row['direc_usu']?>"  />
          <label for="telefono" class="propiedad">Direccion</label>
        </li>
        <!-- Botonera -->
